<%@ Page Language="C#" AutoEventWireup="true" Inherits="Egojit.Web.UI.Page.shopping" ValidateRequest="false" %>
...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	IList<Egojit.Model.cart_items> ls1 = get_cart_list();
	

	int modelt__loop__id=0;
	foreach(Egojit.Model.cart_items modelt in ls1)
	{
		modelt__loop__id++;
	...
	IList<Egojit.Model.cart_items> ls2 = get_cart_list();
	

	int modelt__loop__id=0;
	foreach(Egojit.Model.cart_items modelt in ls2)
	{
		modelt__loop__id++;
