<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="order_edit.aspx.cs" Inherits="Egojit.Web.admin.orders.order_edit" ValidateRequest="false" %>
    ...
    <div class="tab_con" style="display:block;">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="order_table">
          ...
          <tr>
            ...
            <td><%=new Egojit.BLL.payment().GetTitle(model.payment_id) %></td>
          ...
          <tr>
            ...
            <td><%=new Egojit.BLL.distribution().GetTitle(model.distribution_id) %></td>
