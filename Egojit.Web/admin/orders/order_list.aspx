<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="order_list.aspx.cs" Inherits="Egojit.Web.admin.orders.order_list" %>
...
<form id="form1" runat="server">
    ...
    <ItemTemplate>
      <tr>
        ...
        <td><%#new Egojit.BLL.distribution().GetTitle(Convert.ToInt32(Eval("distribution_id")))%></td>
        <td><%#new Egojit.BLL.payment().GetTitle(Convert.ToInt32(Eval("payment_id")))%></td>
