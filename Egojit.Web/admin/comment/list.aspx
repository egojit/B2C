<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="list.aspx.cs" Inherits="Egojit.Web.admin.comment.list" %>
      ...
      <tr>
        <td class="comment">
          <div class="title">
            ...
            <%#new Egojit.BLL.article().GetTitle(Convert.ToInt32(Eval("article_id")))%>
          </div>
          <div class="ask">
