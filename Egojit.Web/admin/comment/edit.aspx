<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="edit.aspx.cs" Inherits="Egojit.Web.admin.comment.edit" ValidateRequest="false" %>
...
<div id="contentTab">
    ...
    <div class="tab_con" style="display:block;">
        <table class="form_table">
            ...
            <tr>
                <th>信息标题：</th>
                <td><%=new Egojit.BLL.article().GetTitle(model.article_id)%></td>
            </tr>
            <tr>
                <th>评论用户：</th>
