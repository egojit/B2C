<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="list.aspx.cs" Inherits="Egojit.Web.admin.download.list" %>
...
<form id="form1" runat="server">
    ...
    <ItemTemplate>
      <tr>
        ...
        <td><%#new Egojit.BLL.category().GetTitle(Convert.ToInt32(Eval("category_id")))%></td>
