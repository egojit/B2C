<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="templet_list.aspx.cs" Inherits="Egojit.Web.admin.settings.templet_list" %>
...
<form id="form1" runat="server">
    ...
    <ItemTemplate>
      <tr>
        ...
        <td><%#Eval("name")%> <img src="../images/icon_view.gif" bigimg="<%#Eval("img")%>" title="查看预览图" alt="" class="imgtip" /></td>
