...
{
    public partial class sys_channel_edit : Egojit.Web.UI.ManagePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(_action) && _action == DTEnums.ActionEnum.Edit.ToString())
            {
                ...
                if (!new Egojit.BLL.sys_channel().Exists(this.id))
                {
        ...
        {
            Egojit.BLL.sys_model bll = new Egojit.BLL.sys_model();
        ...
        private bool DoEdit(int _id)
        {
            ...
            Egojit.Model.sys_channel model = bll.GetModel(_id);
            model.name = txtName.Text.Trim();
            model.title = txtTitle.Text.Trim();
            model.model_id = int.Parse(ddlModelId.SelectedValue);
            model.sort_id = int.Parse(txtSortId.Text.Trim());
