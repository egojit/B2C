<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="center.aspx.cs" Inherits="Egojit.Web.admin.center" %>
...
<div class="navigation nav_icon">你好，<i><%=admin_info.user_name %>(<%=new Egojit.BLL.manager_role().GetTitle(admin_info.role_id) %>)</i>，欢迎进入后台管理中心</div>
