    ...
    public partial class usercenter : Web.UI.UserPage
    {
        ...
        protected override void InitPage()
        {
            ...
            if (action == "exit")
            {
                ...
                //清除Cookies
                Utils.WriteCookie(DTKeys.COOKIE_USER_NAME_REMEMBER, "Egojit", -43200);
                Utils.WriteCookie(DTKeys.COOKIE_USER_PWD_REMEMBER, "Egojit", -43200);
                Utils.WriteCookie("UserName", "Egojit", -1);
                Utils.WriteCookie("Password", "Egojit", -1);
                //自动登录,跳转URL
