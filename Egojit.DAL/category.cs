...
namespace Egojit.DAL
{
    ...
    public partial class category
    {
        ...
        /// 得到一个对象实体
        /// </summary>
        public Egojit.Model.category GetModel(int id)
        {
            StringBuilder strSql = new StringBuilder();
            ...
            Egojit.Model.category model = new Egojit.Model.category();
        ...
        /// 得到一个对象实体(重载，带事务)
        /// </summary>
        public Egojit.Model.category GetModel(SqlConnection conn, SqlTransaction trans, int id)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 id,channel_id,title,call_index,parent_id,class_list,class_layer,sort_id,link_url,img_url,content,seo_title,seo_keywords,seo_description from dt_category ");
            strSql.Append(" where id=@id");
